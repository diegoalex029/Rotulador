...
@WebServlet("/ReporteDireccionNNA")
public class ReporteDireccionNNA extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(formato.equals("PDF")){
	    	...
	    	response.setHeader("Content-disposition","inline; filename=\""+dateFormat.format(date)+"_DireccionGeneralNNA.pdf\"" );
        }else{    
